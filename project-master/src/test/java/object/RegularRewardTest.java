...
public class RegularRewardTest {
    ...
    public void testImage() {
        BufferedImage test;
        try {
            test = ImageIO.read(getClass().getResourceAsStream("/objects/regular_reward.png"));
            assertEquals("Regular Reward",r.name,"asserts that regular reward constructor set name properly");
